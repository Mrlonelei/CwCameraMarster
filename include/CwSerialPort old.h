...
#ifndef __SERIALPORT_H__CAMERA
#define __SERIALPORT_H__CAMERA
...
public:
	...
	void        ClearReadBuffer();//串口发送函数 by mrlong 2008-2-15
...
protected:
	...
	static void	ReceiveChar(CwSerialPortCamera* port, COMSTAT comstat);///接收字符
	static void	WriteChar(CwSerialPortCamera* port);///写字符
	...
	static CString				m_strRecv;
};

#endif __SERIALPORT_H__CAMERA
