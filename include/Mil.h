...
#if M_MIL_USE_LINUX || M_MIL_USE_PPC || __GNUC__
...
#define M_IS_VIDEO_DEVICE_ID(a)                       ((a>=M_VIDEO_DEVICE_ID) && (a<M_VIDEO_DEVICE_ID+M_MAX_VGA_DEVICE))
...
// MIL_ID manipulation macros
   ...
   // SUUU UUUU UUUU RRRR RRRR RRRR RRRR NNNN NNNN NNNN POOO BBBB XXXX XXXX XXXX XXXX
   //
   // where
   ...
   #define M_INVALID_PART_MASK            0xFFFFFFF000800000
...
#define M_SYSTEM_DISTRIBUTED_TYPE                     65L
...
/*                                              to    2446L*/
#define M_MODIFIED_BUFFER_HOOK_MODE                   2447
...
#define M_FPGA_TEMPERATURE                            7301L
#define M_FPGA_TEMPERATURE_MAX_MEASURED               7302L
#define M_FPGA_VOLTAGE_VCCINT                         7303L
#define M_FPGA_VOLTAGE_VCCINT_MIN_MEASURED            7304L
#define M_FPGA_VOLTAGE_VCCINT_MAX_MEASURED            7305L
#define M_FPGA_VOLTAGE_VCCAUX                         7306L
#define M_FPGA_VOLTAGE_VCCAUX_MIN_MEASURED            7307L
#define M_FPGA_VOLTAGE_VCCAUX_MAX_MEASURED            7308L
#define M_PROCESSING_FPGA_TEMPERATURE                 7309L
#define M_PROCESSING_FPGA_TEMPERATURE_MAX_MEASURED    7310L
...
#define M_SYS_INQUIRE_STRING_START                       7700L
   ...
   /*Reserve next values      from                       ((M_SYS_INQUIRE_STRING_START+7L)|M_CLIENT_ASCII_MODE) //7707 */
   ...
   /*Reserve next values      from                       (M_SYS_INQUIRE_STRING_START+7L)  //7707 */
...
/*Reserve next values      from                       (M_SYS_INQUIRE_STRING_START+M_INQUIRE_STRING_SIZE_OFFSET+6)  //7736L */
/*                         to                         (M_SYS_INQUIRE_STRING_START+M_INQUIRE_STRING_SIZE_OFFSET+29) //7759L */
#define M_TRANSPORT_PROTOCOL_SIZE                     (M_SYS_INQUIRE_STRING_START+M_INQUIRE_STRING_SIZE_OFFSET+30) //7760L */
...
//Use M_INQUIRE_STRING_SIZE_OFFSET + inquire type
#define M_CPU_VENDOR_NAME_INQUIRE_SIZE                   (M_CPU_VENDOR_NAME+M_INQUIRE_STRING_SIZE_OFFSET+0) //TBA: MIL should support this inquire
...
// SysControls for modifying the coefficients used in the Vio's colorspace converter
...
#define M_EVENT_SET                                   1707L
#define M_MP_FORCE_ONE_CORE                           1711L
...
#define M_REMOTE_SYSTEM_SELECT                        1816L
#define M_MP_MAX_CORES                                1818L
#define M_MP_ACTIVE_THREAD                            (M_APP_INQUIRE_SYS_START+127L) // 15000+127
#define M_MP_USE                                      (M_APP_INQUIRE_SYS_START+128L) // 15000+128
...
#define M_DIG_INQUIRE_STRING_START                    7700L
   ...
   /*Reserve next values      from                    ((M_DIG_INQUIRE_STRING_START+9L)|M_CLIENT_ASCII_MODE)  //7709 */
   ...
   /*Reserve next values      from                    (M_DIG_INQUIRE_STRING_START+9L)  //7709 */
...
/*Reserve next values      from                       (M_DIG_INQUIRE_STRING_START+M_INQUIRE_STRING_SIZE_OFFSET+4)  //7738L */
...
#define M_COMPRESSION_MODULE                          0x00000200L // Obsolete
...
#define M_GC_FRAME_START                              0x00000007L
#define M_GC_FRAME_END                                0x00000008L
#define M_FRAME_TRANSFER_START                        0x00000005L
#define M_FRAME_TRANSFER_END                          0x00000006L
#define M_GC_EXPOSURE_START                           0x00000003L
#define M_GC_EXPOSURE_END                             0x00000004L

/**  Counter/timer indices that are added should start from one!*/
#define M_COUNTER_START                               0x00000100L
#define M_COUNTER_END                                 0x00000100L
#define M_TIMER_START                                 0x00000110L
#define M_TIMER_END                                   0x00000110L

/************************************   Line numbers are 0-based*/
#define M_LINE_RISING_EDGE                            0x00000120L
#define M_LINE_FALLING_EDGE                           0x00000140L
#define M_LINE_ANY_EDGE                               0x00000180L

/********************************************  Error event types*/
#define M_ERROR_EVENT                                 0x00008000L
...
#define M_BITS_NOT_PART_OF_BUFFER_ATTRIBUTES          (M_IN+M_OUT+M_ALLOW_NULL_ID+M_ALLOW_VIRTUAL_ID+M_HIDDEN+M_PASS_THROUGH)
...
#define M_3DPR_OBJECT                                 (M_USER_ATTRIBUTE       | MAKE_INT64(0x0000000400000000))
#define M_3DMAP_LASER_CONTEXT                         (M_3DPR_OBJECT          | 0x00000001L )
#define M_3DMAP_LASER_DATA                            (M_3DPR_OBJECT          | 0x00000002L )
...
#define M_IS_PACKED_LUT(a)                            (((a&M_IMAGE)==0) && ((a&~(M_MMX_ENABLED|M_READ_PREFETCH_ENABLED|M_DIRECTX|M_VIDEO_MEMORY|M_PROC_GPU)) == (M_LUT|M_PACKED|M_BGR32)))
...
#define M_SCALING_METHOD                              0x00000058L
#define M_TRANSFER_TYPE_KNOWN_BITS                    (M_TRANSFER_METHOD|M_SCALING_METHOD|M_USE_REGION|M_ALLOW_LARGER_RECT|M_SYNCHRONOUS|M_ASYNCHRONOUS)
...
#define M_BUFFER_INFO                          5092L // TBC Will be named M_BUFFER_INFO and changed also M_BUFFER_INFO_OBJECT_VIA_COPY
...
#define M_BUFFER_INFO_COPY                            5202L
...
#define M_DMA_ACCESS                                  0x00000004L
...
#if (BW_COMPATIBILITY == 0x80)
#define M_ASSOCIATED_AUDIO_BUFFER_ID                  8227L
#endif
...
#define M_LOCK_TYPE_MASK                              (M_GPU_ACCESS|M_HOST_ACCESS|M_DMA_ACCESS)
...
#define MIL_FONT_NAME(name)                          ((MIL_INT)MIL_TEXT(name))
/* Using TrueType Font */
#if M_MIL_USE_LINUX
#define M_TTF_FONT_DEFAULT                            MIL_FONT_NAME("DejaVu Sans")
#define M_TTF_FONT_DEFAULT_ASIAN                      MIL_FONT_NAME("Baekmuk Batang")
#else
#define M_TTF_FONT_DEFAULT                            MIL_FONT_NAME("Arial")
#define M_TTF_FONT_DEFAULT_ASIAN                      MIL_FONT_NAME("Arial Unicode MS")
#endif
...
#if !M_MIL_USE_LINUX
#define M_IS_DIRECTX_VERSION_VALID(X)                 ((X == M_DIRECTX_DDRAW7) || (X == M_DIRECTX_D3D9) || (X == M_DIRECTX_NONE)) 
#else
...
#define M_NBERRMSGMAX                                 112 /* max number of error messages     */
...
#define M_MTX_MEM_MANAGER_RESERVED                   (M_MTX_MEM_MANAGER_INFO_START+23L)
...
/* Reserved the next values               from       (M_APP_INQUIRE_SYS_START+729L)*/
/*                                        to         (M_APP_INQUIRE_SYS_START+742L)*/
...
/* Reserve values from                               (M_APP_INQUIRE_STRING_DIRECT_ACCESS_START+M_INQUIRE_STRING_SIZE_OFFSET+6L) */
...
#define M_REG_DEF_START                              (M_APP_INQUIRE_SYS_START+976L)
   ...
   /* Reserve values from                               (M_APP_INQUIRE_SYS_START+1057L)*/
   ...
   /* Reserve values from                               (M_APP_INQUIRE_SYS_START+1425L)*/
   /*                to                                 (M_APP_INQUIRE_SYS_START+1520L)*/   
...
#define M_LICENSE_3DPR               0x00010000L //16L
...
#define M_MORPHISDVR_FINGERPRINT                      (M_LICENSE_FINGERPRINT+32)
...
#define M_CONTROL_FLAG_MASK                 0x00000002L
#define M_STATUS_MASK                       0x0000000CL
#if DISABLE_STACK_BASED_CALL_CONTEXT
#define M_STACK_BASED_FUNCTION              0x00000000L
#else
...
//Reserve next M_MAX_VGA_DEVICE IDs (reserved 16)   -> 20
#define M_RESERVED_ID_END                             M_MAKE_DEFAULT_ID(4 + M_MAX_VGA_DEVICE)
...
#define M_HAS_BUFTRANSFER_FORMAT(X,Y) ( ((M_DIRECTX|M_MTX0) & (X)) && ( ((M_DIRECTX|M_MTX0) & (X) ) == ((M_DIRECTX|M_MTX0) & (Y)) ) )
...
#define M_IN_DIG_INQUIRE_DOUBLE_RANGE(X)   ((((X&~(M_DIG_CONTROL_TYPE_RESERVED_BIT_MASK)) >= M_DIG_INQUIRE_SIZEOF_DOUBLE_START) &&            \
                                             ((X&~(M_DIG_CONTROL_TYPE_RESERVED_BIT_MASK)) <= M_DIG_INQUIRE_SIZEOF_DOUBLE_END)     )        || \
                                            ...
                                            ((X & ~(M_MAX | M_MIN | M_DIG_CONTROL_TYPE_RESERVED_BIT_MASK)) == M_GRAB_EXPOSURE_TIME)        || \
...
#define M_IN_DISP_INQUIRE_STRING_RANGE(InquireType) ((((M_ORIGINAL_DISPLAY_CONTROL(InquireType)&~M_CLIENT_ASCII_MODE) >= M_DISP_INQUIRE_STRING_START)  &&       \
   ...
   #define M_IN_DISP_INQUIRE_MIL_ID_RANGE(X)(((M_ORIGINAL_DISPLAY_CONTROL(X) >= M_DISP_INQUIRE_MIL_ID_START) && (M_ORIGINAL_DISPLAY_CONTROL(X) <= M_DISP_INQUIRE_MIL_ID_END))    || \
                                             ((M_ORIGINAL_DISPLAY_CONTROL(X) >= M_VGA_DEVICE_SYSTEM) && (M_ORIGINAL_DISPLAY_CONTROL(X) <= M_VGA_DEVICE_SYSTEM+M_MAX_VGA_DEVICE)) || \
                                             (X == M_SYSTEM_ASSOCIATED_TO_DX_OBJECT)   || \
                                             (X == M_VGA_SYSTEM_FROM_PHYSICAL_ADDRESS) || \
                                             (X == M_CUSTOM_DISPLAY)                   || \
