...
/************************************************************************/
MILFPGA_EXPORT MIL_INT MILFPGA_EXPORT_TYPE MfpgaCommandAlloc(       MIL_ID SystemId,
                                                MIL_INT DeviceNum,
                                                MIL_INT FunctionId,
...
MILFPGA_EXPORT MIL_INT MILFPGA_EXPORT_TYPE MfpgaCommandFree(        MIL_FPGA_CONTEXT FpgaCommandId,
                                                MIL_INT Flag);

#if M_MIL_USE_UNICODE
MILFPGA_EXPORT MIL_INT MILFPGA_EXPORT_TYPE MfpgaLoadA(MIL_ID SystemId,
                                 MIL_INT FpgaDeviceNum,
                                 MIL_API_CONST char* FirmwareFile,
                                 MIL_INT Flag);
MILFPGA_EXPORT MIL_INT MILFPGA_EXPORT_TYPE MfpgaLoadW(MIL_ID SystemId,
                                 MIL_INT FpgaDeviceNum,
...
#endif
#else
MILFPGA_EXPORT MIL_INT MILFPGA_EXPORT_TYPE MfpgaLoad(MIL_ID SystemId,
                                 MIL_INT FpgaDeviceNum,
                                 MIL_API_CONST_TEXT_PTR FirmwareFile,
                                 MIL_INT Flag);
...
MILFPGA_EXPORT void MILFPGA_EXPORT_TYPE MfpgaSetSource(             MIL_FPGA_CONTEXT FpgaCommandId,
                                                MIL_BUFFER_INFO Buf,
                                                MIL_INT StreamOffset,
                                                MIL_INT Flag);

MILFPGA_EXPORT void MILFPGA_EXPORT_TYPE MfpgaSetDestination(        MIL_FPGA_CONTEXT FpgaCommandId,
                                                MIL_BUFFER_INFO Buf,
                                                MIL_INT StreamOffset,
                                                MIL_INT Flag);

MILFPGA_EXPORT void MILFPGA_EXPORT_TYPE MfpgaSetLink(               MIL_FPGA_CONTEXT SourceFpgaContext,
                                                MIL_INT SourceStreamPort,
                                                MIL_FPGA_CONTEXT DestinationFpgaContext,
                                                MIL_INT DestinationStreamPort,
                                                MIL_INT Flag);

MILFPGA_EXPORT void MILFPGA_EXPORT_TYPE MfpgaCommandQueue(          MIL_FPGA_CONTEXT FpgaCommandId,
                                                MIL_INT CompletionMode,
                                                MIL_INT Flag);

MILFPGA_EXPORT void MILFPGA_EXPORT_TYPE MfpgaGetRegister(           MIL_FPGA_CONTEXT FpgaCommandId,
...
MILFPGA_EXPORT void MILFPGA_EXPORT_TYPE MfpgaSetRegister(           MIL_FPGA_CONTEXT FpgaCommandId,
                                                MIL_INT RegisterBank,
                                                MIL_INT Offset,
                                                MIL_INT Length,
                                                void *ValuePtr,
...
MILFPGA_EXPORT void MILFPGA_EXPORT_TYPE MfpgaCommandControl(        MIL_FPGA_CONTEXT FpgaCommandId,
                                                MIL_INT Flag,
                                                void *ValuePtr);

MILFPGA_EXPORT void MILFPGA_EXPORT_TYPE MfpgaCommandInquire(        MIL_FPGA_CONTEXT FpgaCommandId,
                                                MIL_INT Flag,
                                                void *ValuePtr);

MILFPGA_EXPORT MIL_INT MILFPGA_EXPORT_TYPE MfpgaInquire(            MIL_ID MilSystemId,
                                                MIL_INT FpgaDeviceNumber,
                                                MIL_INT InquireType,
                                                void* ValuePtr);

MILFPGA_EXPORT MIL_INT MILFPGA_EXPORT_TYPE MfpgaControl(            MIL_ID MilSystemId,
                                                MIL_INT FpgaDeviceNumber,
                                                MIL_INT ControlType,
                                                void* ValuePtr);

MILFPGA_EXPORT void MILFPGA_EXPORT_TYPE MfpgaHookFunction(          MIL_ID SystemId,
                                                MIL_INT DeviceNum,
                                                MIL_INT FunctionId,
                                                MIL_INT SubFunctionId,
                                                MIL_INT FunctionNum,
...
MILFPGA_EXPORT MIL_INT MILFPGA_EXPORT_TYPE MfpgaGetHookInfo(        MIL_ID EventId,
                                                MIL_INT InfoType,
                                                void *UserVarPtr);
...
#define M_FPGA_FLAG_OVERSCAN                    0x20000000L
#define M_MULTI_CONTEXT                         0x30000000L

#define M_FPGA_OVERSCAN_SHIFT_A                 16
#define M_FPGA_OVERSCAN_SHIFT_B                 0
#define M_FPGA_OVERSCAN_MASK                    0x0fff
#define M_OVERSCAN_OFFSET(A,B)                  (M_FPGA_FLAG_OVERSCAN | ((A&M_FPGA_OVERSCAN_MASK)<<M_FPGA_OVERSCAN_SHIFT_A) | ((B&M_FPGA_OVERSCAN_MASK)<<M_FPGA_OVERSCAN_SHIFT_B))

#define M_CONTEXT0                              (M_MULTI_CONTEXT | 0)
#define M_CONTEXT1                              (M_MULTI_CONTEXT | 1)
#define M_CONTEXT2                              (M_MULTI_CONTEXT | 2)
#define M_CONTEXT3                              (M_MULTI_CONTEXT | 3)
...
/*                                                                      */
/************************************************************************/
#define M_COMPLETION_MODE                    0x3000
#define M_STREAM_OUTPUT_FORMAT               0x4000
